...
class Settings(BaseSettings):
    ...
    email_provider: str = Field(default="mock")  # mock or live
    ...
    def should_use_mock_services(self) -> bool:
        """Determine if mock services should be used (based on email_provider setting)"""
        return self.email_provider.lower() == "mock"
